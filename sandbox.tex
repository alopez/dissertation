...
\documentclass[12pt]{thesis-2}  % USE IN FINAL VERSION
...
\include{officialtitle} %(must follow Abstract, required, non-numbered)
...
%\newcommand{\figpostamble}{\renewcommand{\baselinestretch}{2}}
